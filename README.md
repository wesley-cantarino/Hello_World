#### Boas referências 
  ...
  * https://shields.io  ![](https://img.shields.io/github/languages/top/badges/shields.svg)
  * https://stackedit.io/
...
0 = primeira vez rodando git
 $ git config --global user.name "seu nome"
 $ git cinfig --global user.email "seu email"
...
9 = $ git push origin master<br>
 ...
 $ git log mostra todos os commits já feitos
